...
import DaoCard from '@/components/ui/DaoCard';
...
export default function Dao(props: any) {
    ...
    return (
        <div className=' bg-gray-800'>
            ...
            <div className='w-full h-full px-16 py-5'>  <div className="grid grid-cols-3 gap-5 ">
            <DaoCard />
            <DaoCard />
            <DaoCard />
            <DaoCard />
